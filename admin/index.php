    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                $barang_terlelang = mysqli_query($conn,"SELECT * FROM lelang where status ='terlelang'");
               ...
               <h1 class="h3 mb-2 text-gray-800">Selamat Datang Di Website Lelang </h1>
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                Petugas</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $jumlah_petugas ?></div>
                        </div>
                        <div class="col-auto">
