...
<?php
include "../koneksi.php";
$sql3 = mysqli_query($conn,"select * from barang where");
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
               ...
               <div class="container-fluid">
                                    ...
                                    $sql2 = mysqli_query($conn,"SELECT * FROM lelang where id_user = '$iduser'");
                                    $row = mysqli_num_rows($sql2);
                                    if ($row > 0) {
                                        $no = 0;
                                        ?>
                                                        <!-- Page Heading -->
                                            <h1 class="h3 mb-2 text-gray-800">Data Barang Yang Sudah Anda Lelang</h1>
                                ...
                                <div class="card shadow mb-4">
                                    <div class="card-header py-3">
                                        <h6 class="m-0 font-weight-bold text-primary">Data Tabel Lelang</h6>
                                    </div>
                                    <div class="card-body">
                                    ...
                                    ?>
                                                        <center>
                        <h1 class="py-3 ">Anda Belum Melakukan Pelelangan</h1>
                    </center>
                                    <?php
                                    }
